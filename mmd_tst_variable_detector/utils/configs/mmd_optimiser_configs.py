...
class MmdOptimisationConfigTemplate(ABC):
    def get_mmd_config_args(self,
                            config_args: data_objects.InterfaceConfigArgs
                            ) -> ty.Union[data_objects.CvSelectionConfigArgs, data_objects.AlgorithmOneConfigArgs]:
        """Extracting the necessary information from the given configuration objects."""
        if config_args.approach_config_args.approach_interpretable_mmd == 'cv_selection':
            mmd_config_args: data_objects.CvSelectionConfigArgs = config_args.detector_algorithm_config_args.mmd_cv_selection_args

            assert mmd_config_args is not None, 'mmd_cv_selection_args is not given.'
            assert isinstance(mmd_config_args, data_objects.CvSelectionConfigArgs), 'mmd_cv_selection_args is not given.'
        elif config_args.approach_config_args.approach_interpretable_mmd == 'algorithm_one':
            mmd_config_args: data_objects.AlgorithmOneConfigArgs = config_args.detector_algorithm_config_args.mmd_algorithm_one_args

            assert mmd_config_args is not None, 'mmd_algorithm_one_args is not given.'
            assert isinstance(mmd_config_args, data_objects.AlgorithmOneConfigArgs), 'mmd_algorithm_one_args is not given.'
        else:
            raise ValueError(f'config_args.approach_config_args.approach_interpretable_mmd: {config_args.approach_config_args.approach_interpretable_mmd}')
        # end if
...
def get_mmd_config_args(config_args: data_objects.InterfaceConfigArgs
                        ) -> ty.Union[data_objects.CvSelectionConfigArgs, data_objects.AlgorithmOneConfigArgs]:
